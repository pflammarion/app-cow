...
function createChip(array $values): bool
{
    ...
    if ($number !== ""){
        $create_chip_sql = "INSERT INTO chip (Chip_Number) VALUES (:number);
                            ...
                            INSERT INTO chip_level (Chip_Id) VALUES ((SELECT Chip_Id FROM chip WHERE Chip_Number = :number));
                            SELECT Cow_Id,:userId FROM cow WHERE Cow_Id = last_insert_id();
                            INSERT INTO chip_level (Chip_Id, Chip_Reference, Chip_First_Level, Chip_Second_Level, Sensor_Id) VALUES (:id, 60, 20, 40, 1);
                            ...
                            SELECT Chip_Id,:chipId FROM chip WHERE Chip_Id = last_insert_id()";
