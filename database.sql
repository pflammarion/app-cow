...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 01 déc. 2022 à 22:20
...
INSERT INTO `chip` (`Chip_Id`, `Chip_Number`, `Sensor_Id`) VALUES
(1, 'ABCDEF1234', NULL),
(2, '1234ABCDEF', NULL),
(3, 'A1BCDEF234', NULL),
(4, 'AB1CDEF234', NULL),
...
INSERT INTO `sensor` (`Sensor_Id`, `Sensor_Name`, `Low_Level`, `Mid_Level`, `High_Level`) VALUES
(1, 'heart frequency', NULL, NULL, NULL),
(2, 'sound', NULL, NULL, NULL),
(3, 'carbon monoxide', NULL, NULL, NULL),
(4, 'battery', NULL, NULL, NULL);
...
ALTER TABLE `chip`
  ...
  ADD KEY `FK_Sensor_ID_Chip_Sensor_Id` (`Sensor_Id`);
...
--
-- Contraintes pour la table `chip`
--
ALTER TABLE `chip`
  ADD CONSTRAINT `FK_Sensor_ID_Chip_Sensor_Id` FOREIGN KEY (`Sensor_Id`) REFERENCES `sensor` (`Sensor_Id`);

--
-- Contraintes pour la table `chip_cow_user`
--
ALTER TABLE `chip_cow_user`
  ADD CONSTRAINT `chip_cow_user_chip_null_fk` FOREIGN KEY (`Chip_Id`) REFERENCES `chip` (`Chip_Id`),
  ADD CONSTRAINT `chip_cow_user_cow_null_fk` FOREIGN KEY (`Cow_Id`) REFERENCES `cow` (`Cow_Id`),
  ADD CONSTRAINT `chip_cow_user_user_null_fk` FOREIGN KEY (`User_Id`) REFERENCES `user` (`User_Id`);

--
-- Contraintes pour la table `data_sensor`
--
ALTER TABLE `data_sensor`
  ADD CONSTRAINT `data_sensor_average_null_fk` FOREIGN KEY (`Average_Id`) REFERENCES `average` (`Average_Id`),
  ADD CONSTRAINT `data_sensor_chip_null_fk` FOREIGN KEY (`Chip_Id`) REFERENCES `chip` (`Chip_Id`);
COMMIT;
