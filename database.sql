...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 02 déc. 2022 à 00:22
...
INSERT INTO `chip` (`Chip_Id`, `Chip_Number`, `Low_Level`, `Mid_Level`, `High_Level`, `Sensor_Id`) VALUES
(1, 'ABCDEF1234', NULL, NULL, NULL, NULL),
(2, '1234ABCDEF', NULL, NULL, NULL, NULL),
(3, 'A1BCDEF234', NULL, NULL, NULL, NULL),
(4, 'AB1CDEF234', NULL, NULL, NULL, NULL),
(5, 'ABC1DEF234', NULL, NULL, NULL, NULL),
(6, 'ABCD1EF234', NULL, NULL, NULL, NULL),
(7, 'ABCDE1F234', NULL, NULL, NULL, NULL),
(8, 'ABCDEF4321', NULL, NULL, NULL, NULL),
(9, 'HUGOTUMETB', NULL, NULL, NULL, NULL);
...
CREATE TABLE `chip_cow_user` (
  ...
  `Chip_Number` char(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
